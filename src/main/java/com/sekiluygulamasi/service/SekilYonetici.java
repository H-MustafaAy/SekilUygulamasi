package com.sekiluygulamasi.service;

import com.sekiluygulamasi.model.Sekil;
...
public class SekilYonetici {
    ...
    public void setSembol(String yeniSembol) {
        ...
        char sembolChar = yeniSembol.charAt(0);
        if (!GECERLI_SEMBOLLER.contains(sembolChar)) {
            throw new IllegalArgumentException("Geçersiz sembol! İzin verilen semboller: " + GECERLI_SEMBOLLER);
